...
<!-- Limpando o CACHE de pagina -->
	...
	<meta http-equiv="Pragma" CONTENT="no-cache">
		...
		<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
		<title>Inserir Estado - Bonus</title>
...
<!-- Formulario JSP que é representado pela classe EnderecoForm -->
		<form action="estadoAction.do">
			...
			<h1>Estado</h1>
			<table>
				<html:hidden property="idEstado" name="estadoForm"/>
				<tr>
					<td>
						<label>Nome do Estado</label>
					</td>
					<td>
						<html:text property="descricao" name="estadoForm" size="50" />
					</td>
				</tr>
			</table>
			</div>
