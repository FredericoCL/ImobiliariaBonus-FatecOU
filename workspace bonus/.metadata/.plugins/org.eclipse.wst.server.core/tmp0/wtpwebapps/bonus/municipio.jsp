...
<!-- Limpando o CACHE de pagina -->
	...
	<meta http-equiv="Pragma" CONTENT="no-cache">
		...
		<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
		<title>Inserir Município - Bonus</title>
...
<!-- Formulario JSP que é representado pela classe EnderecoForm -->
		<form action="municipioAction.do">
			...
			<h1>Município</h1>
			<table>
				<html:hidden property="idMunicipio" name="municipioForm"/>
				<tr>
					<td>
						<label>Nome do Município</label>
					</td>
					<td>
						<html:text property="descricao" name="municipioForm" size="50" />
					</td>
				</tr>
			</table>
			</div>
