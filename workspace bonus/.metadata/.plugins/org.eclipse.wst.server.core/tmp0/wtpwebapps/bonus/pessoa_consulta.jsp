...
<title>Imobiliária Bonus - Pessoa</title>
...
<table>
	...
	<logic:iterate id="pessoaCorrente" name="pessoaForm" property="pessoas" type="br.com.bonus.pessoa.pessoa.model.PessoaVO">
		<tr>
			<td width="75px">${ pessoaCorrente.idPessoa }</td>
			<td width="75px">${ pessoaCorrente.nome }</td>
			<td width="75px">${ pessoaCorrente.email }</td>
			<td width="75px">${ pessoaCorrente.dataNascimento }</td>
		</tr>
	</logic:iterate>
	
	<tr>
		<td>
			<div id="menu_modal_txt"><a href="pessoaAction.do?method=abrirTela">Voltar</a></div>
		</td>
	</tr>
