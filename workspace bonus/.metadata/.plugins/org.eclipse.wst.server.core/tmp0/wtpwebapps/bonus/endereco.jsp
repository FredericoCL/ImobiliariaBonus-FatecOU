...
<!-- Formulario JSP que é representado pela classe EnderecoForm -->
		<html:form action="/enderecoAction">
			...
			<h1>Endereço</h1>
			<table>
				<html:hidden property="idEndereco" name="enderecoForm"/>
				<tr>
					<td>
						<label>Logradouro</label>
					</td>
					<td>
						<html:text property="logradouro" name="enderecoForm" size="50" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="numero" name="enderecoForm" size="20" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="complemento" name="enderecoForm" size="20" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="bairro" name="enderecoForm" size="50" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="cep" name="enderecoForm" size="30" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:select property="codMunicipio" name="enderecoForm" >
							<html:option value="0">Selecione o Município&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</html:option>
							<html:optionsCollection property="listaMunicipios" value="idMunicipio" 
								label="descricao" name="enderecoForm"/>
						</html:select>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:select property="codEstado" name="enderecoForm" >
							<html:option value="0">Selecione o Estado&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</html:option>
							<html:optionsCollection property="listaEstados" value="idEstado" 
								label="descricao" name="enderecoForm"/>
						</html:select>
					</td>
				</tr>	
				...
				<tr>
					...
					<td>
						<html:select property="codPais" name="enderecoForm" >
							<html:option value="0">Selecione o País&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</html:option>
							<html:optionsCollection property="listaPaises" value="idPais" 
								label="descricao" name="enderecoForm"/>
						</html:select>
					</td>
				</tr>		
