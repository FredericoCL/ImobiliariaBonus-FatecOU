...
<table>
	...
	<logic:iterate id="estadoCorrente" name="estadoForm" property="estados" type="br.com.bonus.endereco.estado.model.EstadoVO">
		<tr>
			<td width="75px">${ estadoCorrente.idEstado }</td>
			<td width="75px">${ estadoCorrente.descricao }</td>
		</tr>
	</logic:iterate>
</table>
</div>
...
<table>
	<tr>
		<td>
			<div id="menu_modal_txt"><a href="estadoAction.do?method=abrirTela">Voltar</a></div>
		</td>
	</tr>
