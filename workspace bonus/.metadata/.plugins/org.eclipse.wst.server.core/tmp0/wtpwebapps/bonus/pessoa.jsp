		...
		<form action="enderecoAction.do">
			...
			<table>
				<tr>
					...
					<td>
						<html:text property="idPessoa" name="pessoaForm" size="05" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="nome" name="pessoaForm" size="50" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="email" name="pessoaForm" size="50" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="dataNascimento" name="pessoaForm" size="50" />
					</td>
				</tr>
