...
<table>
	...
	<logic:iterate id="paisCorrente" name="paisForm" property="paises" type="br.com.bonus.endereco.pais.model.PaisVO">
		<tr>
			<td width="75px">${ paisCorrente.idPais }</td>
			<td width="75px">${ paisCorrente.descricao }</td>
		</tr>
	</logic:iterate>
</table>
</div>
...
<table>
	<tr>
		<td>
			<div id="menu_modal_txt"><a href="paisAction.do?method=abrirTela">Voltar</a></div>
		</td>
	</tr>
