...
<table>
	...
	<tr>
		...
		<td width="150px"><b><u>Tipo de Telefone</u></b></td>
	</tr>
	
	<logic:iterate id="tipoTelefoneCorrente" name="tipoTelefoneForm" property="tipoTelefones" type="br.com.bonus.telefone.tipotelefone.model.TipoTelefoneVO">
		<tr>
			<td width="75px">${ tipoTelefoneCorrente.idTipoTelefone }</td>
			<td width="75px">${ tipoTelefoneCorrente.descricao }</td>
		</tr>
	</logic:iterate>
</table>
</div>
...
<table>
	<tr>
		<td>
			<div id="menu_modal_txt"><a href="tipoTelefoneAction.do?method=abrirTela">Voltar</a></div>
		</td>
	</tr>
