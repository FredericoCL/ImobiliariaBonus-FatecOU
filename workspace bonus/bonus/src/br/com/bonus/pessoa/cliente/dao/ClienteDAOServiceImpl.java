 ...
 * @since 22/11/2013 09:42:38
 * @version 1.0
 */
public class ClienteDAOServiceImpl extends AbstractDAO implements ClienteDAOService{

	/**
	 * Polimorfico
	 * @see br.com.bonus.pessoa.cliente.dao.ClienteDAOService#inserir(br.com.bonus.pessoa.cliente.model.ClienteVO)
	 */
	@Override
	public void inserir( ClienteVO vo ) throws InserirException {
		...
		try {
			 ...
			 * foi inserido.
			 */
			vo.setIdCliente( (Integer) sessao.save( vo ) );
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.pessoa.cliente.dao.ClienteDAOService#alterar(br.com.bonus.pessoa.cliente.model.ClienteVO)
	 */
	@Override
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.pessoa.cliente.dao.ClienteDAOService#excluir(br.com.bonus.pessoa.cliente.model.ClienteVO)
	 */
	@Override
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.pessoa.cliente.dao.ClienteDAOService#consultarPorNome(java.lang.String)
	 */
	...
	public ArrayList< ClienteVO > consultarPorCpf( String cpf ) throws ConsultarException {
		...
		try {
			...
			Query query = sessao.createQuery( "Select p FROM ClienteVO p where p.nome LIKE :cpf" );
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.pessoa.cliente.dao.ClienteDAOService#consultarTodos()
	 */
	@SuppressWarnings( "unchecked" )
    @Override
	public ArrayList< ClienteVO > consultarTodos() throws ConsultarException {
		...
		try {
			...
			final String HQL = "SELECT idio FROM ClienteVO idio ORDER BY idio.nome ASC";
