 ...
 * @since 16/11/2013 01:27:19
 * @version 1.0
 */
public class TipoNegociacaoDAOServiceImpl extends AbstractDAO implements TipoNegociacaoDAOService{

	/**
	 * Polimorfico
	 * @see br.com.bonus.imovel.tiponegociacao.dao.TipoNegociacaoDAOService#inserir(br.com.bonus.imovel.tiponegociacao.model.TipoNegociacaoVO)
	 */
	@Override
	public void inserir( TipoNegociacaoVO vo ) throws InserirException {
		...
		try {
			 ...
			 * foi inserido.
			 */
			vo.setIdTipoNegociacao( (Integer) sessao.save( vo ) );
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.imovel.tiponegociacao.dao.TipoNegociacaoDAOService#alterar(br.com.bonus.imovel.tiponegociacao.model.TipoNegociacaoVO)
	 */
	@Override
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.imovel.tiponegociacao.dao.TipoNegociacaoDAOService#excluir(br.com.bonus.imovel.tiponegociacao.model.TipoNegociacaoVO)
	 */
	@Override
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.imovel.tiponegociacao.dao.TipoNegociacaoDAOService#consultarPorDescricao(java.lang.String)
	 */
	@Override
	public ArrayList< TipoNegociacaoVO > consultarPorDescricao( String descricao ) throws ConsultarException {
		...
		try {
			...
			Query query = sessao.createQuery( "Select p FROM TipoNegociacaoVO p where p.descricao LIKE :descricao" );
			query.setString( "descricao", "%" + descricao + "%" );

			// Executando a Query retornando o casting de seu resultado.
			return (ArrayList< TipoNegociacaoVO >) query.list();
	...
	/**
	 * Polimorfico
	 * @see br.com.bonus.imovel.tiponegociacao.dao.TipoNegociacaoDAOService#consultarTodos()
	 */
	@Override
	public ArrayList< TipoNegociacaoVO > consultarTodos() throws ConsultarException {
		...
		try {
			...
			final String HQL = "SELECT idio FROM TipoNegociacaoVO idio ORDER BY idio.descricao ASC";
