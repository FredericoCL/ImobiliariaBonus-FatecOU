...
public class PaisAction extends DispatchAction{
	...
	/**
	 * 
	 * Método responsável por abrir a tela de Pais
	...
	public ActionForward abrirTela( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		// Pegando o ActionForm e o retransformando(Especializando) em PaisForm.
		PaisForm meuForm = (PaisForm) form;
		...
		return mapping.findForward( "pais_cadastro" );
	...
	public ActionForward inserir( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		PaisVO vo = new PaisVO(  null, meuForm.getDescricao() ) ;

		try {
			PaisService.getInstance().inserir( vo );
		...
		// Localizando e abrindo a tela cujo apelido é o informado no parametro.
		return mapping.findForward( "pais_consulta" );

	}//Fim do método Inserir
	
	private void atualizarTabela( PaisForm meuForm ) throws ConsultarException {
		meuForm.getPaises().clear();
		//Preenchendo a lista de Idiomar
		ArrayList< PaisVO > encontrados = PaisService.getInstance().consultarTodos();
		meuForm.getPaises().addAll( encontrados );
	...
	public ActionForward alterar( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		//Criando um VO para Simular a inserção
		PaisVO vo = new PaisVO( Integer.parseInt (meuForm.getIdPais() ), meuForm.getDescricao() );

		try {
			PaisService.getInstance().alterar( vo );
	...
	public ActionForward excluir( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		try {
			PaisService.getInstance().excluir( vo );
