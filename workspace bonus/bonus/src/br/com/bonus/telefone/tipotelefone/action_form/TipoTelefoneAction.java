...
import br.com.bonus.telefone.tipotelefone.controller.TipoTelefoneService;
 ...
 * @since 04/11/2013 15:29:00
 * @version 1.0
 */
public final class TipoTelefoneAction extends DispatchAction{
	...
	public ActionForward abrirTela( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		// Pegando o ActionForm e o retransformando(Especializando) em TipoTelefoneForm.
		TipoTelefoneForm meuForm = (TipoTelefoneForm) form;
		
		//Limpando os campos
		meuForm.setIdTipoTelefone( "" );
		meuForm.setDescricao( "" );
		
		// Localizando e abrindo a tela cujo apelido é o informado no parametro.
		return mapping.findForward( "tipo_telefone_cadastro" );
	...
	public ActionForward inserir( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		TipoTelefoneVO vo = new TipoTelefoneVO(  null, meuForm.getDescricao() ) ;

		try {
			TipoTelefoneService.getInstance().inserir( vo );
		...
		// Localizando e abrindo a tela cujo apelido é o informado no parametro.
		return mapping.findForward( "tipo_telefone_consulta" );

	}//Fim do método Inserir
	
	private void atualizarTabela( TipoTelefoneForm meuForm ) throws ConsultarException {
		meuForm.getTipoTelefones().clear();
		//Preenchendo a lista de Idiomar
		ArrayList< TipoTelefoneVO > encontrados = TipoTelefoneService.getInstance().consultarTodos();
		meuForm.getTipoTelefones().addAll( encontrados );
	...
	public ActionForward alterar( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		//Criando um VO para Simular a inserção
		TipoTelefoneVO vo = new TipoTelefoneVO( Integer.parseInt (meuForm.getIdTipoTelefone() ), meuForm.getDescricao() );

		try {
			TipoTelefoneService.getInstance().alterar( vo );
	...
	public ActionForward excluir( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) {
		...
		try {
			TipoTelefoneService.getInstance().excluir( vo );
